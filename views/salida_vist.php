...
<div class="container marketing">
  ...
  <div class="row">
    ...
    if($PagosPendientes == null ){
      ...
      echo '<h3>Salida de Visitante: </h3><br><p>Recuerde solicitar alguna indentificación al visitante antes de ingresar</p>
    ...
    foreach ($PagosPendientes as $fila) {
      ...
      echo '<p class="text-center"><a class="btn btn-primary btn-sm"
              href="salida_vist.php?op=1&hab_id='.$fila['hab_id'].'">Salida</a></p>';
