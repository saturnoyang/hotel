...
if($hab != 0){
  ...
  <form action="sbr_comp.php?op=3&id='.$id.'&hab='.$hab.'" method="post" enctype="multipart/form-data">
    Seleccione la imagen del comprobante de pago:<br>
    <input type="file" name="fileToUpload" id="fileToUpload"><br>
    <input type="submit" value="Subir Comprobante" name="submit">
  </form>
...
?>
    ...
    if($reservaciones == null ){
      ...
      echo '  <h2>Se han encontrado los siguientes datos: </h2>
                  ...
                  <table class="table">
                    ...
                    foreach ($reservaciones as $fila) {
                      ...
                      echo "<td>".'<a class="btn btn-primary"
                              href="sbr_comp.php?op=2&id='.$id.'&hab='.$fila['id'].'">Subir Comprobante</a></td></tr>';
                    }
    }
